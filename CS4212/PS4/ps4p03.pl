...
% This code only showcases the execution engine of s|TAC|k.
% The test cases show the direction translation of the TAC code from 
% compilation of the HLL programs.
