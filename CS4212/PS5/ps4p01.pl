...
compileStmt( return, goto RetLbl,_Procs,Glob,TG,Glob,TG,Loc,TL,
		Loc,TL,MaxTop,MaxTop,_Lev,RetLbl) :- !.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Assume that calling function is X also
% With Tail Call Optimization.
%
% The assumption here is that the calling <function> and the last
% statement that calls return <function> both refer to the same 
% function with the same signatures
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

compileStmt( (return P#Args), Code,Procs,Glob,TG,Glob,TG,
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Tail Recursive versions of Factorial and GCD were used to test 
