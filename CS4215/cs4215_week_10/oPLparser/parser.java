...
public class parser extends java_cup.runtime.lr_parser
{
	...
	/** Production table. */
	protected static final short _production_table[][] = unpackFromStrings(new String[] { "\000\063\000\002\002\003\000\002\002\004\000\002\002"
	...
	/** Parse-action table. */
	protected static final short[][] _action_table = unpackFromStrings(new String[] { "\000\173\000\040\004\014\005\021\006\005\007\010\010"
			...
			+ "\027\uffe5\030\uffe5\031\uffe5\032\uffe5\033\uffe5\034\uffe5\035"
			+ "\uffe5\036\uffe5\037\uffe5\040\uffe5\042\uffe5\043\uffe5\044\uffe5"
			+ "\045\uffe5\046\uffe5\047\uffe5\050\uffe5\051\uffe5\052\uffe5\053" + "\uffe5\001\002" });
	...
	protected static final short[][] _reduce_table = unpackFromStrings(new String[] { "\000\173\000\004\002\012\001\001\000\004\002\171\001"
			...
			+ "\002\001\001\000\002\001\001\000\002\001\001\000\002"
			+ "\001\001\000\004\002\173\001\001\000\002\001\001\000" + "\002\001\001" });
...
class CUP$parser$actions
{
			...
			int CUP$parser$top) throws java.lang.Exception
	{
		...
		case 50: // letDefinitionList ::=
		{
			...
			CUP$parser$result = parser.getSymbolFactory().newSymbol("letDefinitionList", 9,
		...
		case 49: // letDefinitionList ::= letDefinition letDefinitionList
		{
			...
			LetDefinition ld = (LetDefinition) ((java_cup.runtime.Symbol) CUP$parser$stack
			...
			Vector<LetDefinition> lds = (Vector<LetDefinition>) ((java_cup.runtime.Symbol) CUP$parser$stack
					.peek()).value;
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 48: // notEmptyLetDefinitionList ::= letDefinition
					// letDefinitionList
		{
			Vector<LetDefinition> RESULT = null;
			int ldleft = ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 1)).left;
			...
			lds.insertElementAt(ld, 0);
			RESULT = lds;
			CUP$parser$result = parser.getSymbolFactory().newSymbol("notEmptyLetDefinitionList", 8,
					((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 1)),
					((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
		}
			return CUP$parser$result;
		...
		case 47: // letDefinition ::= IDENTIFIER EQUAL expression
		{
			...
			CUP$parser$result = parser.getSymbolFactory().newSymbol("letDefinition", 7,
		...
		case 46: // expressionList ::=
		{
			...
			CUP$parser$result = parser.getSymbolFactory().newSymbol("expressionList", 2,
					((java_cup.runtime.Symbol) CUP$parser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
		}
			return CUP$parser$result;
		...
		case 45: // expressionList ::= expression expressionList
		{
			...
			Vector<Expression> es = (Vector<Expression>) ((java_cup.runtime.Symbol) CUP$parser$stack
					.peek()).value;
			es.insertElementAt(e, 0);
			RESULT = es;
			CUP$parser$result = parser.getSymbolFactory().newSymbol("expressionList", 2,
					((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 1)),
					((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
		...
		case 44: // notEmptyExpressionList ::= expression expressionList
		{
			...
			es.insertElementAt(e, 0);
			RESULT = es;
			CUP$parser$result = parser.getSymbolFactory().newSymbol("notEmptyExpressionList", 1,
					((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 1)),
					((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
		}
			return CUP$parser$result;
		...
		case 43: // identifierList ::=
		{
			...
			CUP$parser$result = parser.getSymbolFactory().newSymbol("identifierList", 4,
					((java_cup.runtime.Symbol) CUP$parser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
		}
			return CUP$parser$result;
		...
		case 41: // notEmptyIdentifierList ::= IDENTIFIER identifierList
		{
			...
			is.insertElementAt(i, 0);
			RESULT = is;
			CUP$parser$result = parser.getSymbolFactory().newSymbol("notEmptyIdentifierList", 3,
					((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 1)),
					((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
		}
			return CUP$parser$result;
		...
		case 40: // associationList ::=
		{
			...
			CUP$parser$result = parser.getSymbolFactory().newSymbol("associationList", 6,
					((java_cup.runtime.Symbol) CUP$parser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
		}
			return CUP$parser$result;
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 39: // associationList ::= PROPERTY COLON expression
					// associationListRest
		{
			Vector<Association> RESULT = null;
			...
			Vector<Association> as = (Vector<Association>) ((java_cup.runtime.Symbol) CUP$parser$stack
					.peek()).value;
			as.insertElementAt(new Association(p, e), 0);
			RESULT = as;
			CUP$parser$result = parser.getSymbolFactory().newSymbol("associationList", 6,
		...
		case 38: // associationListRest ::=
		{
			Vector<Association> RESULT = null;
			RESULT = new Vector<Association>();
			CUP$parser$result = parser.getSymbolFactory().newSymbol("associationListRest", 5,
					((java_cup.runtime.Symbol) CUP$parser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
		}
			return CUP$parser$result;
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 37: // associationListRest ::= COMMA PROPERTY COLON expression
					// associationListRest
		{
			Vector<Association> RESULT = null;
			int pleft = ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 3)).left;
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 36: // method ::= METHOD PROPERTY LPAREN identifierList RPAREN
					// ARROW expression END
		{
			...
			Vector<String> is = (Vector<String>) ((java_cup.runtime.Symbol) CUP$parser$stack
			...
			CUP$parser$result = parser.getSymbolFactory().newSymbol("method", 11,
		...
		case 35: // methodList ::=
		{
			Vector RESULT = null;
			RESULT = new Vector();
			CUP$parser$result = parser.getSymbolFactory().newSymbol("methodList", 10,
					((java_cup.runtime.Symbol) CUP$parser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
		}
			return CUP$parser$result;
		...
		case 34: // methodList ::= method methodList
		{
			...
			Association m = (Association) ((java_cup.runtime.Symbol) CUP$parser$stack
					.elementAt(CUP$parser$top - 1)).value;
		...
		case 33: // expression ::= CLASS EXTENDS expression methodList END
		{
			...
			Vector ms = (Vector) ((java_cup.runtime.Symbol) CUP$parser$stack
					.elementAt(CUP$parser$top - 1)).value;
			ms.insertElementAt(new Association("Parent", e), 0);
			RESULT = new Record(ms);
			CUP$parser$result = parser.getSymbolFactory().newSymbol("expression", 0,
					((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 4)),
					((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
		}
			return CUP$parser$result;
		...
		case 32: // expression ::= CLASS methodList END
		{
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 31: // expression ::= expression DOT PROPERTY LPAREN expressionList
					// RPAREN
		{
			Expression RESULT = null;
			...
			Vector<Expression> args = (Vector<Expression>) ((java_cup.runtime.Symbol) CUP$parser$stack
					.elementAt(CUP$parser$top - 1)).value;
			...
			Expression lookupResult = new LookupApplication(new Variable("lookup"), lookupArgs);
		...
		case 30: // expression ::= expression ASSIGN expression
		{
			...
			else
			{
				...
				{
					RESULT = new RecordAssignment(((BinaryPrimitiveApplication) e1).argument1,
							((BinaryPrimitiveApplication) e1).argument2, e2);
				}
				else
					System.out.println("parse error before :=");
			}
			;
		...
		case 22: // expression ::= LBRACKET associationList RBRACKET
		{
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 21: // expression ::= LPAREN expression notEmptyExpressionList
					// RPAREN
		{
			Expression RESULT = null;
			int eleft = ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 2)).left;
		...
		case 20: // expression ::= LPAREN expression RPAREN
		{
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 19: // expression ::= RECFUN IDENTIFIER notEmptyIdentifierList
					// ARROW expression END
		{
			Expression RESULT = null;
			...
			Vector<String> xs = (Vector<String>) ((java_cup.runtime.Symbol) CUP$parser$stack
					.elementAt(CUP$parser$top - 3)).value;
			int eleft = ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 1)).left;
			int eright = ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 1)).right;
			Expression e = (Expression) ((java_cup.runtime.Symbol) CUP$parser$stack
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 18: // expression ::= FUN notEmptyIdentifierList ARROW expression
					// END
		{
			Expression RESULT = null;
			int xsleft = ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 3)).left;
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 17: // expression ::= LET notEmptyLetDefinitionList IN expression
					// END
		{
			Expression RESULT = null;
			int ldsleft = ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 3)).left;
			int ldsright = ((java_cup.runtime.Symbol) CUP$parser$stack
					...
					// END
		{
			...
			Expression e3 = (Expression) ((java_cup.runtime.Symbol) CUP$parser$stack
					.elementAt(CUP$parser$top - 1)).value;
