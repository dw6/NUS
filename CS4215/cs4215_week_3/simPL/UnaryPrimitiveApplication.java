...
public class UnaryPrimitiveApplication implements Expression
{
	...
	{
		return new UnaryPrimitiveApplication(operator, argument.eliminateLet());
	}
	...
	{
		return new UnaryPrimitiveApplication(operator, argument.substitute(var, replacement));
	}
	...
	{
		return operator.equals("\\") && (argument.reducible() || argument instanceof BoolConstant);
	}
	...
	public Expression oneStep()
	{
		if (operator.equals("\\"))
			if (argument.reducible())
				return new UnaryPrimitiveApplication(operator, argument.oneStep());
