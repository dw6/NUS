...
public class BinaryPrimitiveApplication implements Expression
{
	...
	{
		return new BinaryPrimitiveApplication(operator, argument1.substitute(var, newexp),
	...
	public boolean reducible()
	{
		...
		(operator.equals("+") || operator.equals("-") || operator.equals("*")
				...
				(operator.equals("&") || operator.equals("|")) && // operator is
																	// boolean
				...
				(operator.equals("+") || operator.equals("-") || // operator (no
																	// div)
						operator.equals("*") || operator.equals("=") || // requires
																		// integers
	...
	public Expression oneStep()
	{
		...
		if ((operator.equals("+") || operator.equals("-") || operator.equals("*")
				|| operator.equals("/") || operator.equals("=") || operator.equals(">")
				|| operator.equals("<") || operator.equals("&") || operator.equals("|"))
				&& (argument1.reducible() || (IsValue.isValue(argument1) && argument2.reducible())))
			if (argument1.reducible())
				// Reduce first argument
				return new BinaryPrimitiveApplication(operator, argument1.oneStep(), argument2);
			else
				// (IsValue.isValue(argument1) && argument2.hasRedex())
				return new BinaryPrimitiveApplication(operator, argument1, argument2.oneStep());

		// Case 2:
		// boolean operator applies
		else if ((operator.equals("&") || operator.equals("|"))
				&& argument1 instanceof BoolConstant && argument2 instanceof BoolConstant)
		{
		...
		// Case 3:
		// integer operator applies (no division)
		else if ((operator.equals("+") || operator.equals("-") || // operator
																	// (no div)
				operator.equals("*") || operator.equals("=") || // requires
																// integers
				operator.equals(">") || operator.equals("<")) && // and
		...
		// Case 4:
		// division applies
		else if (operator.equals("/") && argument1 instanceof IntConstant
				&& argument2 instanceof IntConstant && ((IntConstant) argument2).value != 0)
	...
	public String toXML()
	{
		return "<simpl:binaryprimitiveapplication>\n"
				...
				+ ((operator.equals(">")) ? "&gt;" : (operator.equals("<")) ? "&lt;" : (operator
						.equals("&")) ? "&amp;" : operator) + "</simpl:operator>\n"
